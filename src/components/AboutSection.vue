...
<template>
  <section id="about" class="py-24 px-4 md:px-8 bg-white dark:bg-slate-900/50 relative overflow-hidden" aria-labelledby="about-title" data-motion-section>
    ...
    <div class="container mx-auto max-w-7xl relative z-10">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start" data-motion="fade-up" data-motion-step="1">
        <div class="space-y-8">
          <div class="relative">
