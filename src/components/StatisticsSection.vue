...
const stats = [
  { value: "20+", key: "projects", icon: "fa-solid fa-project-diagram", tone: "primary" },
  { value: "1+", key: "experience", icon: "fa-solid fa-calendar-check", tone: "secondary" },
  { value: "Full-Stack", key: "stack", icon: "fa-solid fa-layer-group", tone: "accent" },
  { value: "∞", key: "learning", icon: "fa-solid fa-graduation-cap", tone: "primary" },
];
</script>
  ...
  <section id="statistics-section" class="py-24 px-4 md:px-8 bg-slate-50 dark:bg-transparent relative overflow-hidden" aria-label="Professional highlights">
    <div class="container mx-auto max-w-7xl relative z-10">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
        <div v-for="(stat, index) in stats" :key="stat.key" class="text-center" data-motion="fade-up" :data-motion-mobile="index > 0 ? 'skip' : undefined" :data-motion-step="index">
