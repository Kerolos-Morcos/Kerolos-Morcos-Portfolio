    ...
    <div class="container mx-auto max-w-7xl relative z-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <article v-for="(skill, index) in skills" :key="skill.id" class="skill-card main-skill-card bg-white dark:bg-slate-800/30 backdrop-blur-sm rounded-2xl p-8 border border-slate-300 dark:border-slate-700">
          <div data-motion="fade-up" :data-motion-step="index % 3">
      ...
      <div class="secondary-tech-list mt-16 grid grid-cols-2 md:grid-cols-4 gap-6" aria-label="Supporting technologies" data-motion="fade-up" data-motion-mobile="only" data-motion-step="3">
