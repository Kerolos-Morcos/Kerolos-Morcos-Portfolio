export const skills = [
  ...
  { id: "mysql", name: "MySQL", icon: "fa-solid fa-database", color: "secondary", tone: "secondary", description: { ar: "تصميم وربط قواعد بيانات MySQL مع تطبيقات الويب", en: "Designing and integrating MySQL databases for web applications" } },
  { id: "rest", name: "REST APIs", icon: "fa-solid fa-plug", color: "accent", tone: "accent", description: { ar: "ربط الواجهات بخدمات REST باستخدام Axios وasync/await", en: "Connecting frontends to REST APIs with Axios and async/await" } },
];
